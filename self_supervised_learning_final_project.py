...
class MoCoCovLoss(nn.Module):
    def __init__(self, temperature=0.15, lambda_cov=0.005, use_queue_for_cov=False):
        """
...
class MoCoQueue(nn.Module):
    ...
    """
    def __init__(self, size=32768, dim=128):
        super().__init__()
        self.size = size
        self.dim = dim
...
def knn_classifier(train_feats, train_labels, test_feats, test_labels, k=20, temperature=0.15, device=None):
    """
