...
class MoCoCovLoss(nn.Module):
    def __init__(self, temperature=0.07, lambda_cov=1.0, use_queue_for_cov=False):
        """
...
def knn_classifier(train_feats, train_labels, test_feats, test_labels, k=20, temperature=0.07, device=None):
    """
