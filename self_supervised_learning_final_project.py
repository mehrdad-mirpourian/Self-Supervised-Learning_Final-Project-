...
queue = MoCoQueue(size=4096, dim=128).to(device)
...
# ===============================================================
# For Lambda: use a normal Linux directory, not /content
# ===============================================================

DATA_SOURCE = "local_30k"    # options: "local_15k", "hf_full"

# IMPORTANT:
# On Lambda you must upload or download your dataset here:
LOCAL_DATA_DIR = "/home/ubuntu/local_pretrain_30k"
...
# ===============================================================
#  FAST DOWNLOAD USING snapshot_download()
# ===============================================================
...
if DATA_SOURCE == "local_30k":
    ...
    repo_dir = snapshot_download(
        ...
        repo_type="dataset",
        local_dir="/home/ubuntu/hf_raw",   # <— FIXED for Lambda
...
ssl_dataset = LocalMoCoDataset(
    root_dir=LOCAL_DATA_DIR,   # <= MUST be /home/ubuntu/... in Lambda
...
def knn_classifier(train_feats, train_labels, test_feats, test_labels, k=10, temperature=0.1, device=None):
    """
    ...
    batch_size = 200   # small enough for 4090/A100/V100 memory
